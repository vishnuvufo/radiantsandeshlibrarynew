...
package com.mountfox.cropimage;
...
import com.mountfox.cropimage.provider.ImageSelectionProvider;
...
//        outputFileUri = FileProvider.getUriForFile(context, "com.mountfox.cropimage" + ".provider",
//                new File(getImage.getPath(), "pickImageResult.jpeg"));
//      } else {
//        outputFileUri = Uri.fromFile(new File(getImage.getPath(), "pickImageResult.jpeg"));
//      }
